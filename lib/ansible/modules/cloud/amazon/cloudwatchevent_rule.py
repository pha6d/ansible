        ...
        for target in targets:
            ...
            if 'ecs_parameters' in target:
                ...
                if 'task_count' in target['ecs_parameters']:
                    target_request['EcsParameters']['TaskCount'] = ecs_parameters['task_count'] if (type(ecs_parameters['task_count']) is int or type(ecs_parameters['task_count']) is long) else long(ecs_parameters['task_count'])
